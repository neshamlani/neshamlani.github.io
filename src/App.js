...
import { skillsList } from "./constants/skillList";
...
const App = () => {
  ...
  const InfoChip = ({ src, title }) => (
    <div className="chips">
      <img src={src} className="chipsImg" />
        ...
        <div className="container">
          ...
          <div className="row" ref={aboutMeRef}>
            ...
            <div className="col-md-6 p-4 p-md-5">
              <img src={me} alt="Nesh Amlani" className="w-75" />
            </div>
          </div>
          {/* Work Experience */}
              ...
              <div className="d-flex flex-column">
                ...
                <div className="d-flex">
                  <a
                    ...
                    rel="noreferrer"
                  >
                    <img src={github} className="chipsImg" />
                  </a>
                  <a
                    ...
                    rel="noreferrer"
                  >
                    <img src={linkedin} className="chipsImg" />
                  </a>
                  <a
                    ...
                    rel="noreferrer"
                  >
                    <img src={twitter} className="chipsImg" />
                  </a>
                </div>
              </div>
            </div>
